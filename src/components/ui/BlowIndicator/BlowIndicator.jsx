...
const BlowIndicator = ({ 
  ...
  // Calculate how much of the SVG to reveal based on smoothed audio level
  const normalizedLevel = smoothedLevel / threshold;
  
  // Calculate clip percentage - starts at 90% (only 10% visible)
  // As audio level increases, clip percentage decreases to reveal more
  const clipPercentage = Math.max(100 - (normalizedLevel * 100), 0);
